...
// end include: /tmp/tmpl89f5cb8.js
...
var ASM_CONSTS = {
 ...
 587070: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 587153: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 587222: () => { return window.innerWidth; },  
 587252: () => { return window.innerHeight; }
};
